													...
													<div class="main-card mb-3 card">
														...
														<div class="row">
															<div class="col-sm-12 col-md-12 col-lg-6">
																<?php
																$data = mysqli_query($koneksi, "select * from db_usermanager where username='$username' AND tipe_akun='finance'");
																...
																?>
																	<form class="input_form" method="post" action=".act?value=edit_data_profil" enctype="multipart/form-data" novalidate style="border:1px solid transparent;">
																		...
																		<div class="form_input">
																			<input type="text" class="form-control readonly_text" id="username_agen" name="username_agen" value="<?php echo $d['username_agen']; ?>" disabled>
																			<label>Agen</label>
																		</div>
																		<div class="form_input">
																			<input type="text" class="form-control" id="nama" name="nama" value="<?php echo $d['nama']; ?>" required>
																			<label>Nama Lengkap<sup class="wajib">*</sup></label>
																			<div class="invalid-feedback">
																				Nama <?php echo $feedback; ?>
																			</div>
																		</div>
																		<div class="form_input">
