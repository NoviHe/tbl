			...
			<div class="mb-3 card">
				<div class="tabs-lg-alternate card-header">
					<ul class="nav nav-justified">
						...
						<li class="nav-item">
							<a href="usermanager?p=agen" class="nav-link">
								<div class="widget-number small_info">
									<i class="pe-7s-box2 settings"></i> 
									<span>Agen</span>
								</div>
						...
						<li class="nav-item">
							<a href="usermanager?p=karyawan" class="nav-link active">
								<div class="widget-number small_info">
									<i class="pe-7s-box2 settings"></i> 
									<span>Karyawan</span>
								</div>
									...
									<div class="main-card mb-3 card" style="padding-bottom:0px;">
										<div class="form_grup_with_judul" style="background:#fff!important; margin-bottom:-20px;">
											<div class="judul" style="margin-left:-16px; margin-right:-16px;">
												Staf Karyawan
												<a href="" data-toggle="modal" data-target="#modals_tambah_<?php echo $staf_karyawan;?>" data-backdrop="static" data-keyboard="false" class="tambah_media">
													+
												</a>
											</div>
										</div>
