$(function () {
	...
	function fetchSelect(val, info, value, back, back2) {
		...
		if (info == "kecamatan") {
			linkurl = base_url + "api/getKelurahanTujuan/" + dataVal[0];
		}
		var newidtj = "";
		if (idtj != "") {
		...
		$.getJSON(linkurl, function (r) {
			...
			if (info == "kecamatan") { //console.log(dataVal); console.log(dataBack2);
				param = r.data.KelurahanDetail;
				firstVal = dataVal[0];
				firstText = dataVal[1];
			...
			if (info == "kelurahan") { //console.log(dataVal); console.log(dataBack2);
				param = r.data.KelurahanDetail;
        firstVal = dataVal[0];
				firstText = dataVal[1];
				placeholder = dataVal[1];
				optionsfirst = '<option value="' + dataVal[0] + '" >'+dataBack2[1] + ", " + dataBack2[2]+ ", " + dataBack2[3] + ", " +placeholder + '</option>';
				firstdataInfo = 'data-info="kecamatan"';
				backV = dataBack[0] + "#" + dataBack[1] + "#" + dataBack[2]+ "#" + dataBack[3];
				backV2 = dataBack2[0] + "#" + dataBack2[1] + "#" + dataBack2[2]+ "#" + dataBack2[3];
				firstconnection = 'data-connection="' + dataBack[3] + '#' + dataBack2[3] + '" data-back="' + backV + '#' + dataVal[0] + '"  data-back2="' + backV2 + '#' + dataVal[1] + '"';
			}
			...
			if (defaultText == "Kota" || defaultText == "Kecamatan" || defaultText == "Kelurahan" || info == "main") {
				if (info != "kelurahan") {
					setTimeout(function () {
