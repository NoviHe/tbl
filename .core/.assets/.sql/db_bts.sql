...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2020 at 05:34 AM
...
INSERT INTO `data_login` (`id`, `judul_informasi`, `informasi_login`, `tagline_login_footer`, `logo_login`, `bg_login`) VALUES
(1, 'Infomasi', 'BTS Cargo merupakan perusahaan yang  mulai ber-operasional secara mandiri sejak tahun 2020 yang bergerak dalam bidang jasa pengiriman barang baik padat , cair , alat berat, kendaraan, dan hewan. Pengiriman barang BTS Cargo memiliki beberapa jalur pengiriman diantaranya ada pengiriman lewat darat, laut dan udara dengan harga yang murah.', 'Copyright © 2020 - Solution on Your Package Everywhere | BTS Cargo', '1114logo.png', '9017bg-login.jpg');
...
--
-- Table structure for table `db_marketing`
--
...
--
-- Dumping data for table `db_marketing`
--
...
--
-- Indexes for table `db_marketing`
--
...
--
ALTER TABLE `data_resi`
  MODIFY `id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=217;
...
--
-- AUTO_INCREMENT for table `db_marketing`
--
ALTER TABLE `db_marketing`
