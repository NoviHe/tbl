		...
		<div class="border-box">
			...
			<form class="form_validation" method="post" action="" role="form" novalidate>
				<div class="form-row">
					...
					<input type="text" class="form-control" name="username" placeholder="" required style="text-transform:uppercase;">
				...
				<div class="modal-footer clearfix">
					...
					<div class="float-right">
						<button class="btn btn-lg btn-login">Login Agen</button>
					</div>
				</div>
			</form>
