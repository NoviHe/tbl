	<div id="printarea" class="row">
		<div class="col-sm-12 col-md-12 col-xl-12">
			<div class="main-card mb-3 card" style="border:none;">
				...
				<?php
					$no = 1;
					$query = mysqli_query($koneksi,"select * from laporan_pengeluaran where tanggal >= '$tanggal_awal 00:00:00' and tanggal <= '$tanggal_akhir 23:59:59'");
				?>					
						...
						<tbody>					
							...
							<tr>		
								...
								<td class="nominal_cetak">
									<?php
										$data = mysqli_query($koneksi,"select sum(jumlah) as jumlah_pengeluaran_cetak_data from laporan_pengeluaran where tanggal >= '$tanggal_awal 00:00:00' and tanggal <= '$tanggal_akhir 23:59:59'");
