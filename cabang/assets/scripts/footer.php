	...
	<script>
		$('#tabel_data_resi').removeAttr('width').dataTable({
			"scrollY": "180px",
			"scrollX": true,
			"scrollCollapse": true,
			"paging": false,
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form_validation" method="post" action=".act?value=tambah_data_resi" enctype="multipart/form-data" novalidate>
							...
							<div class="row">
								<div class="col-sm-12 col-md-12 col-lg-4">
									<div class="position-relative form-group">
										...
										<input type="text" class="form-control input disabled" name="" value="<?php echo $kota['kota']; ?> - <?php echo $username; ?>" disabled style="padding-top:7px;">
									</div>
								</div>
								<div class="col-sm-12 col-md-12 col-lg-4">
									<div class="position-relative form-group">
										...
										<input type="text" class="form-control input validasi_modals" name="tujuan" required style="padding-top:7px;">
									</div>
								</div>
								<div class="col-sm-12 col-md-12 col-lg-4">
									<div class="position-relative form-group">
	...
	<?php
	$data = mysqli_query($koneksi, "select * from data_resi where dari = '" . $kota['kota'] . "'");
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form_validation" method="post" action="" enctype="multipart/form-data" novalidate>
							...
							<div class="row">
								<div class="col-sm-12 col-md-12 col-lg-12 text-right">
									<a href=".act?value=hapus_data_resi&id=<?php echo $d['id']; ?>" class="mt-1 btn btn-primary save_data" style="margin:15px 0px 0px 0px!important;">
										Hapus
									</a>
									<button class="mt-1 btn btn-primary save_data" data-dismiss="modal" aria-label="Close" style="margin:15px 0px 0px 10px!important;">
										Batal
	...
	<!-- LAPORAN RESI -->
	<!-- Modals Edit & Detail Laporan Resi -->
	<?php
	$bulan = date('m');
	$tahun = date('Y');
	$data = mysqli_query($koneksi, "select * from laporan_resi where username_agen ='$username' AND month(tanggal)>='$bulan' AND year(tanggal)>='$tahun'");
	while ($d = mysqli_fetch_array($data)) {
	?>
		<div id="modals_edit_laporan_resi_<?php echo $d['no_resi']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						...
						<a href="pengiriman" class="close">
							<span aria-hidden="true">&times;</span>
						</a>
					</div>
					<div class="modal-body">
						<?php include "assets/scripts/data/form-edit-resi.php"; ?>
					</div>
	...
	while ($d = mysqli_fetch_array($data)) {
	?>
		<div id="modals_hapus_laporan_resi_<?php echo $d['no_resi']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">
					...
					<div class="modal-body">
						<?php include "assets/scripts/data/form-hapus-resi.php"; ?>
					</div>
	...
	<!-- Modals Tambah Data Marketing -->
	<div id="modals_tambah_data_marketing" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Tambah Data Marketing</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<div class="modal-body">
					<form class="form_validation" method="post" action=".act?value=tambah_data_marketing" enctype="multipart/form-data" novalidate>
						<input type="hidden" name="dari" value="<?php echo $kota['kota']; ?>">
						<div class="form_grup_with_judul" style="margin-bottom:0px;">
							<div class="judul">
								Data Marketing
							...
							<div class="row">
								<div class="col-sm-12 col-md-12 col-lg-8">
									<div class="position-relative form-group">
										...
										<input type="text" class="form-control input disabled modals_padding" name="" value="<?php echo $kota['kota']; ?>" disabled>
									</div>
								</div>
								<div class="col-sm-12 col-md-12 col-lg-4">
									<div class="position-relative form-group">
										...
										<input type="text" class="form-control input validasi_modals modals_padding" name="nama" required>
									</div>
								</div>
							</div>
						</div>
	...
	<!-- Modals Edit Data Marketing -->
	<?php
	$data = mysqli_query($koneksi, "select * from db_marketing where dari = '" . $kota['kota'] . "'");
	while ($d = mysqli_fetch_array($data)) {
	?>
		<div id="modals_edit_data_marketing_<?php echo $d['id']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">Edit Data Marketing</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
					<div class="modal-body">
						<form class="form_validation" method="post" action=".act?value=edit_data_marketing" enctype="multipart/form-data" novalidate>
							<input type="hidden" name="id" value="<?php echo $d['id']; ?>">
								...
								<div class="row">
									...
									<div class="col-sm-12 col-md-12 col-lg-4">
										<div class="position-relative form-group">
											...
											<input type="text" class="form-control input validasi_modals modals_padding" name="nama" value="<?php echo $d['nama']; ?>" required>
										</div>
									</div>
								</div>
							</div>
	...
	<!-- Modals Hapus Data Marketing -->
	<?php
	$data = mysqli_query($koneksi, "select * from db_marketing where dari = '" . $kota['kota'] . "'");
	while ($d = mysqli_fetch_array($data)) {
	?>
		<div id="modals_hapus_data_marketing_<?php echo $d['id']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
					...
					<div class="modal-body">
						<form class="form_validation" method="post" action=".act?value=hapus_data_marketing&id=<?php echo $d['id']; ?>" enctype="multipart/form-data" novalidate>
							<input type="hidden" name="id" value="<?php echo $d['id']; ?>">
								...
								<div class="row">
									...
									<div class="col-sm-12 col-md-12 col-lg-4">
										<div class="position-relative form-group">
											...
											<input type="text" class="form-control input validasi_modals modals_padding" name="nama" value="<?php echo $d['nama']; ?>" disabled>
										</div>
									</div>
								</div>
							</div>
	...
	while ($d = mysqli_fetch_array($data)) {
	?>
		<div id="modals_action_invoice_resi_<?php echo $d['no_resi']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lgx">
				<div class="modal-content">
					...
					<div class="modal-body">
						<?php include "assets/scripts/data/form-konfirmasi-payment.php"; ?>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- Modals Action Invoice -->
	<?php
	$data = mysqli_query($koneksi, "select * from laporan_invoice");
	while ($d = mysqli_fetch_array($data)) {
	?>
		<div id="modals_konfirmasi_invoice_resi_<?php echo $d['id']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lgx">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">Konfirmasi</h5>
					...
					<div class="modal-body">
						<?php include "assets/scripts/data/form-konfirmasi-invoice.php"; ?>
					</div>
				</div>
			</div>
		</div>
	...
	while ($d = mysqli_fetch_array($data)) {
	?>
		<div id="modals_payments_laporan_resi_<?php echo $d['no_resi']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">
					...
					<div class="modal-body">
						<?php include "assets/scripts/data/form-resi-payments.php"; ?>
					</div>
	...
	<!-- Modal Input INVOICE -->
	<div id="modals_tambah_invoice" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-xl">
			<div class="modal-content">
				...
				<div class="modal-body" style="margin-bottom:-30px;">
					<?php include "assets/scripts/data/form-laporan-invoice.php"; ?>
				</div>
			</div>
		</div>
	</div>

	<!-- Modals Hapus Laporan INVOICE -->
	<?php
	$data = mysqli_query($koneksi, "select * from laporan_invoice");
	while ($d = mysqli_fetch_array($data)) {
	?>
		<div id="modals_hapus_laporan_invoice_<?php echo $d['id']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lgx">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">
					...
					<div class="modal-body">
						<?php include "assets/scripts/data/form-hapus-invoice.php"; ?>
					</div>
	...
	<!-- Hapus Nanti Kalo Sudah Ga Ada Data -->
	<script>
		$('#tabel_data_resi_x').dataTable({
			"scrollY": "180px",
			"scrollCollapse": true,
			"paging": false,
			"order": [
