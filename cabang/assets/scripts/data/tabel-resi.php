						...
						<tr>
							<td style="text-align:center; width:5px;">
								<a class="text-danger" href="" data-toggle="modal" data-target="#modals_hapus_data_resi_<?php echo $d['id'];?>" data-backdrop="static" data-keyboard="false">
									<i class="fa fa-trash" style="font-size:0.73rem;"></i>
								</a>
							</td>
							<td style="text-align:center; width:5px;">
								<?php echo $no++;?>
							...
							<td style="text-align:left; width:160px; padding-left:10px;">
								<a class="text-danger" href="" data-toggle="modal" data-target="#modals_edit_data_resi_<?php echo $d['id'];?>" data-backdrop="static" data-keyboard="false" style="text-decoration:none; font-weight:500;  font-size:0.72rem; text-transform:uppercase;">
									<?php echo $d['tujuan'];?>
								</a>
							</td>
