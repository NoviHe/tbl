		...
		<div class="row">
			...
			<div class="col-sm-12 col-md-12 col-lg-3">
				<div class="position-relative form-group">
					...
					<select class="form_select form-control select2_penting custom-select" id="layanan" name="layanan" required style="cursor:pointer;">
			...
			<div class="col-sm-12 col-md-12 col-lg-2">
				<div class="position-relative form-group">
					...
					<div class="input-group">
						...
						<input type="number" class="form-control input nomor text-right" id="biaya_pengiriman" name="biaya_pengiriman" value="0" required style="padding-right:10px;">
					</div>
				</div>
			</div>
			<div class="col-sm-12 col-md-12 col-lg-2">
				...
				<div class="col-sm-12 col-md-12 col-lg-10">
					<div class="position-relative form-group">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control input nomor bg_yellow disabled" onclick="total_tagihan()" id="total_harga_bulanan" name="total_harga_bulanan" value="0" readonly>
							<div class="input-group-append">
								<span class="btn btn-secondary form_grup_data">
									/Hari
								</span>
