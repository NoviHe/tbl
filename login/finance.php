		...
		<div class="form_login">
			...
			<span class="dua">
				...
				<form class="form_login_register" method="post" action="" role="form">
					...
					<button type="submit" class="btn btn_login">Login Finance</button>
				</form>
			</span>
	...
	<?php 
		if($_SERVER['REQUEST_METHOD']=='POST'){
			...
			if($user=='' || $pass==''){
				...
				include "../config.php";
				$pass=md5($pass.$salt);
				$sqlLogin = mysqli_query($koneksi, "SELECT * FROM db_usermanager WHERE username='$user' AND password='$pass' AND tipe_akun='finance'");
