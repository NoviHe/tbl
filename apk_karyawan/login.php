...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($user == '' || $pass == '') {
        ...
        include "../config.php";
        $pass = md5($pass . $salt);
        $sqlLogin = mysqli_query($koneksi, "SELECT * FROM db_usermanager WHERE username='$user' AND password='$pass' AND tipe_akun='staf_karyawan'");
