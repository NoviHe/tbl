	<div id="printarea" class="row">
		<div class="col-sm-12 col-md-12 col-xl-12">
			<div class="main-card mb-3 card" style="border:none;">
				<form class="no_print input_form_out" method="post" action="laporan-pengeluaran-cetak-data" enctype="multipart/form-data" novalidate>
					<div class="row">
				...
				<?php
					$no = 1;
					$query = mysqli_query($koneksi,"select * from laporan_pengeluaran where tanggal >= '$tanggal_awal 00:00:00' and tanggal <= '$tanggal_akhir 23:59:59' AND username_agen='$username_agen'");
				?>					
					...
					<table id="cetak_data" class="table table-hover table-striped table-bordered">
						<thead>
							<tr>
								<th>No.</th>
								<th>Tanggal</th>
								<th>Kode<span class="no_print"> Pengeluaran</span></th>
						...
						<tbody>					
							...
							<tr>		
								...
								<td class="print_keterangan" style="width:400px">
							...
							?>	
							<tr>		
								<td colspan="4" class="total_cetak">
								...
								<td class="nominal_cetak">
									<?php
										$data = mysqli_query($koneksi,"select sum(jumlah) as jumlah_pengeluaran_cetak_data from laporan_pengeluaran where tanggal >= '$tanggal_awal 00:00:00' and tanggal <= '$tanggal_akhir 23:59:59' AND username_agen='$username_agen'");
										$d = mysqli_fetch_assoc($data);
										$jumlah_pengeluaran_cetak_data = $d['jumlah_pengeluaran_cetak_data'];
									?>
									Rp. 
									<?php 
										echo number_format($jumlah_pengeluaran_cetak_data,0,',','.');
									?>
								</td>				
							</tr>	
						</tbody>
